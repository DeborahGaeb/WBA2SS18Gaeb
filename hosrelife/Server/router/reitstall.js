...
app.post('/reitstaelle', function(req, res){
...
app.get('/reitstaelle', function(req, reply){
...
app.get('/reitstaelle/:id', function(req, res){
...
app.delete('/reitstaelle/:id', function(req, res){
...
app.put('reitstaelle/:id', jsonParser, function(req, res){
    var neu = req.body;
...
app.post('/freieBoxen', function(req, res){
...
app.get('/freieBoxen/:id', function(req, res){
...
app.put('/freieBoxen/:id', jsonParser, function (req, res) {
    var neu = req.body;
    neu.id = req.params.id;
...
//Alle Boxen ausgeben
app.get('/freieBoxen', function(req, res){
...
app.delete('/freieBoxen/:id', function(req, res){
...
app.post('/lehrgang', function(req, res){
    ...
    client.incr('nextLehrgangID', function(err, reply){
...
//Eine freie Box abfragen
app.get('/lehrgang/:id', function(req, res){
...
app.put('/lehrgang/:id', jsonParser, function (req, res) {
    var neu = req.body;
    neu.id = req.params.id;
...
app.get('/lehrgang', function(req, res){
...
//löschen einer freien Boxen
app.delete('/lehrgang/:id', function(req, res){
